        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="form-inline my-2 my-lg-0">
                    ...
                    <a href="inchargehome.php" class="btn btn-outline-light active">Filed complaints</a>
...
<br>
<center><h2>Complaints Filed</h2></center>
                        <?php
                        ...
                        $department=$_SESSION['department'];
                        $query="select * from `details` where department='$department' and checked='no'";
                            ...
                            echo "<div class='row'>";
                                ...
                                while($res2 = mysqli_fetch_assoc($result))
                                {
                                    if($res2["token"]==0)
                                    {
                                        ...
                                        echo "<br><a href=viewform.php?myNumber=".$res2['sname'].">View Form</a>
                                        </div>
                                        </div>
                                        </div>
                                    ...
                                    $string = $res2["comments"];
                                        ...
                                        echo "<br><a href=viewform1.php?myNumber=".$res2['token'].">View Form</a>
                                        </div>
                                        </div>
                                        </div>
                                        " ;
